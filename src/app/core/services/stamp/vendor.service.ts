...
export class VendorService {
    ...
    getStampVendorList(
        ...
        return this.http
            .patch<
                IapiResponce<GetStampVendors>
            >('v1/StampMaster/StampVendorList', queryParameters)
            .pipe(
                catchError((error) => {
    ...
    addNewStampVendor(paylod: FormData): Observable<IapiResponce> {
        ...
        return this.http
            .post<IapiResponce>('v1/StampMaster/CreateStampVendor', paylod, {
                headers,
            })
            .pipe(
                catchError((error) => {
    ...
    deleteStampVendor(id: Number): Observable<IapiResponce> {
        return this.http
            .delete<IapiResponce>(
                'v1/StampMaster/DeleteStampVendorsById?id=' + id
            )
            .pipe(
                catchError((error) => {
                    throw this.toastService.showError(error.message);
