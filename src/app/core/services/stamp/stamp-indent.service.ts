...
export class StampIndentService {
    ...
    getAllStampIndents(
        ...
        return this.http
            .patch<
                IapiResponce<GetStampIndents>
            >('v1/Stamp/StampIndentList', queryParameters)
            .pipe(
                catchError((error) => {
    ...
    getAllStampIndentsProcessing(
        ...
        return this.http
            .patch<
                IapiResponce<GetStampIndents>
            >('v1/Stamp/StampIndentListProcessing', queryParameters)
            .pipe(
                catchError((error) => {
                    throw this.toastService.showError(error.message);
                })
    ...
    getAllStampIndentsProcessed(
        ...
        return this.http
            .patch<
                IapiResponce<GetStampIndents>
            >('v1/Stamp/StampIndentListProcessed', queryParameters)
            .pipe(
                catchError((error) => {
                    throw this.toastService.showError(error.message);
                })
    ...
    addNewStampIndent(payload: AddStampIndent): Observable<IapiResponce> {
        return this.http
            .post<IapiResponce>('v1/Stamp/CreateStampIndent', payload)
            .pipe(
                catchError((error) => {
                    throw this.toastService.showError(error.message);
                })
    ...
    getStampIndentDetails(
        id: number
    ): Observable<IapiResponce<GetStampIndents>> {
        return this.http
            .get<IapiResponce>('v1/Stamp/IndentDetailsById?id=' + id)
            .pipe(
                catchError((error) => {
                    throw this.toastService.showError(error.message);
                })
    ...
    receiveIndent(id: number): Observable<IapiResponce<GetStampIndents>> {
        return this.http
            .get<IapiResponce>(
                'v1/Stamp/ReceiveStampIndent?stampIndentId=' + id
            )
            .pipe(
                catchError((error) => {
                    throw this.toastService.showError(error.message);
    ...
    rejectIndentByIndentId(id: number): Observable<IapiResponce<boolean>> {
        return this.http
            .get<
                IapiResponce<boolean>
            >(`v1/Stamp/RejectStampIndent?stampIndentId=${id}`)
            .pipe(
                catchError((error) => {
                    throw this.toastService.showError(error.message);
                })
