...
const routes: Routes = [
    ...
    {
        path: 'modules/pension-process/ppo/entry/family-nominee',
        loadChildren: () =>import('./pensions/pension-process/ppo/entry/ppodetails/family-nominee/family-nominee.module').then(m => m.FamilyNomineeModule),
        data: { breadcrumb: 'FamilyNomineeModule' }
    },
    {
        path: 'modules/pension-process/pension-bill',
    ...
    {
        path: 'modules/pension-process/pension-bill/regular-pension',
        loadChildren: () => import('./pensions/pension-process/pension-bill/regular-pension-pension-bill/regular-pension-pension-bill.module').then(m => m.RegularPensionPensionBillModule),
        data: { breadcrumb: 'RegularPensionPensionBillModule' }
    },
    {
        path: 'modules/pension-process/pension-bill/first-pension',
        loadChildren: () => import('./pensions/pension-process/pension-bill/first-pension-pension-bill/first-pension-pension-bill.module').then(m => m.FirstPensionPensionBillModule),
        data: { breadcrumb: 'FirstPensionPensionBillModule' }
    },
    {
        path: 'modules/pension-process/ppo/convert-to-family-pension',
        loadChildren: () => import('./pensions/pension-process/ppo/convert-to-family-pension/convert-to-family-pension.module').then(m => m.ConvertToFamilyPensionModule),
