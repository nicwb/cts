...
const routes: Routes = [
    {
        path: '',
        component: PensionsProcessComponent,
        data: { breadcrumb: 'PensionsProcessComponent' },
    },
    {
        path: 'approval',
        loadChildren: () =>
    ...
    },
    {
        ...
        loadChildren: () =>
            import('./pensioner-details/pensioner-details.module').then(
                (m) => m.PensionerDetailsModule
            ),
    ...
    },
    {
        path: 'pension-bill',
        loadChildren: () =>
            import('./pension-bill/pension-bill.module').then(
                (m) => m.PensionBillModule
            ),
    ...
    },
    {
        path: 'bill-print',
        loadChildren: () =>
            import('./bill-print/bill-print.module').then(
                (m) => m.BillPrintModule
            ),
