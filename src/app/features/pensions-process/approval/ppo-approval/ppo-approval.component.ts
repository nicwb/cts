...
export class PpoApprovalComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.idList$ =
            this.pensionPPODetailsService.getAllNotApprovedPensioners();
    ...
    async loadTableData(): Promise<void> {
        ...
        try {
            const response: PensionerResponseDTOJsonAPIResponse =
                await firstValueFrom(
                    this.pensionPPODetailsService.getPensionerByPpoId(
                        this.ApprovalForm.get('ppoId')?.value
                    )
                );
            if (
