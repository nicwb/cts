...
import { PensionPPODetailsService, PensionPPOStatusService, PensionBankBranchService, PensionerResponseDTOJsonAPIResponse, APIResponseStatus, PensionStatusFlag } from 'src/app/api';
...
export class PpoApprovalComponent implements OnInit {
    ...
    askApproval(){
        this.router.navigate(['pension-process/approval/ppo-approval', this.ApprovalForm.value['ppoId']]);
    }
    ...
    onDialogClose(){
        this.router.navigate(['pension-process/approval/ppo-approval']);
    }
