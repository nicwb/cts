...
export class PensionFirstBillService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllPposForFirstBill(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PensionerListItemDTOTableResponseDTOJsonAPIResponse>;
    public getAllPposForFirstBill(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PensionerListItemDTOTableResponseDTOJsonAPIResponse>>;
    public getAllPposForFirstBill(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PensionerListItemDTOTableResponseDTOJsonAPIResponse>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPposForFirstBillPrint(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PensionerListItemDTOTableResponseDTOJsonAPIResponse>;
    public getPposForFirstBillPrint(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PensionerListItemDTOTableResponseDTOJsonAPIResponse>>;
    public getPposForFirstBillPrint(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PensionerListItemDTOTableResponseDTOJsonAPIResponse>>;
    public getPposForFirstBillPrint(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
