...
export class PensionComponentRevisionService {
     ...
     * @deprecated
     */
    public createPpoComponentRevisions(
        ppoId: number,
        ppoComponentRevisionEntryDTO?: Array<PpoComponentRevisionEntryDTO>,
        observe?: 'body',
    ...
    ): Observable<PpoComponentRevisionResponseDTOListJsonAPIResponse>;
    public createPpoComponentRevisions(
        ppoId: number,
        ppoComponentRevisionEntryDTO?: Array<PpoComponentRevisionEntryDTO>,
        observe?: 'response',
        ...
        HttpResponse<PpoComponentRevisionResponseDTOListJsonAPIResponse>
    >;
    public createPpoComponentRevisions(
        ppoId: number,
        ppoComponentRevisionEntryDTO?: Array<PpoComponentRevisionEntryDTO>,
        ...
        HttpEvent<PpoComponentRevisionResponseDTOListJsonAPIResponse>
    >;
    public createPpoComponentRevisions(
        ppoId: number,
        ppoComponentRevisionEntryDTO?: Array<PpoComponentRevisionEntryDTO>,
        ...
        if (ppoId === null || ppoId === undefined) {
            throw new Error(
                'Required parameter ppoId was null or undefined when calling createPpoComponentRevisions.'
            );
        }
        ...
        return this.httpClient.request<PpoComponentRevisionResponseDTOListJsonAPIResponse>(
            'post',
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createSinglePpoComponentRevision(
        ppoId: number,
    ...
    ): Observable<PpoComponentRevisionResponseDTOJsonAPIResponse>;
    public createSinglePpoComponentRevision(
        ppoId: number,
        ppoComponentRevisionEntryDTO?: PpoComponentRevisionEntryDTO,
        observe?: 'response',
    ...
    ): Observable<HttpResponse<PpoComponentRevisionResponseDTOJsonAPIResponse>>;
    public createSinglePpoComponentRevision(
        ppoId: number,
        ppoComponentRevisionEntryDTO?: PpoComponentRevisionEntryDTO,
        observe?: 'events',
    ...
    ): Observable<HttpEvent<PpoComponentRevisionResponseDTOJsonAPIResponse>>;
    public createSinglePpoComponentRevision(
        ppoId: number,
        ppoComponentRevisionEntryDTO?: PpoComponentRevisionEntryDTO,
        observe: any = 'body',
        ...
        if (ppoId === null || ppoId === undefined) {
            throw new Error(
                'Required parameter ppoId was null or undefined when calling createSinglePpoComponentRevision.'
            );
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deletePpoComponentRevisionById(
        revisionId: number,
        observe?: 'body',
        reportProgress?: boolean,
        options?: {
    ...
    public deletePpoComponentRevisionById(
        ...
        if (revisionId === null || revisionId === undefined) {
            throw new Error(
                'Required parameter revisionId was null or undefined when calling deletePpoComponentRevisionById.'
            );
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllPposForComponentRevisions(
        observe?: 'body',
        reportProgress?: boolean,
        options?: {
            httpHeaderAccept?: 'application/json';
    ...
    ): Observable<PpoComponentRevisionPpoListItemDTOTableResponseDTOJsonAPIResponse>;
    public getAllPposForComponentRevisions(
        observe?: 'response',
        reportProgress?: boolean,
        options?: {
        ...
        HttpResponse<PpoComponentRevisionPpoListItemDTOTableResponseDTOJsonAPIResponse>
    >;
    public getAllPposForComponentRevisions(
        observe?: 'events',
        reportProgress?: boolean,
        ...
        HttpEvent<PpoComponentRevisionPpoListItemDTOTableResponseDTOJsonAPIResponse>
    >;
    public getAllPposForComponentRevisions(
        observe: any = 'body',
        reportProgress: boolean = false,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPpoComponentRevisionsByPpoId(
        ppoId: number,
        observe?: 'body',
        reportProgress?: boolean,
        options?: {
    ...
    ): Observable<PpoComponentRevisionResponseDTOIEnumerableJsonAPIResponse>;
    public getPpoComponentRevisionsByPpoId(
        ppoId: number,
        observe?: 'response',
        reportProgress?: boolean,
        ...
        HttpResponse<PpoComponentRevisionResponseDTOIEnumerableJsonAPIResponse>
    >;
    public getPpoComponentRevisionsByPpoId(
        ppoId: number,
        observe?: 'events',
        ...
        HttpEvent<PpoComponentRevisionResponseDTOIEnumerableJsonAPIResponse>
    >;
    public getPpoComponentRevisionsByPpoId(
        ppoId: number,
        observe: any = 'body',
        ...
        if (ppoId === null || ppoId === undefined) {
            throw new Error(
                'Required parameter ppoId was null or undefined when calling getPpoComponentRevisionsByPpoId.'
            );
        }
        ...
        let localVarPath = `/api/v1/ppo/${this.configuration.encodeParam({ name: 'ppoId', value: ppoId, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}/component-revision`;
        return this.httpClient.request<PpoComponentRevisionResponseDTOIEnumerableJsonAPIResponse>(
            'get',
            `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updatePpoComponentRevisionById(
        revisionId: number,
    ...
    public updatePpoComponentRevisionById(
        ...
        if (revisionId === null || revisionId === undefined) {
            throw new Error(
                'Required parameter revisionId was null or undefined when calling updatePpoComponentRevisionById.'
            );
        }
