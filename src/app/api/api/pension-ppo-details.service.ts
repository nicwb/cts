...
export class PensionPPODetailsService {
    ...
    ): Observable<PensionerResponseDTOJsonAPIResponse>;
    public createPensioner(
        pensionerEntryDTO?: PensionerEntryDTO,
        observe?: 'response',
        reportProgress?: boolean,
    ...
    ): Observable<HttpResponse<PensionerResponseDTOJsonAPIResponse>>;
    public createPensioner(
        pensionerEntryDTO?: PensionerEntryDTO,
        observe?: 'events',
        reportProgress?: boolean,
    ...
    ): Observable<HttpEvent<PensionerResponseDTOJsonAPIResponse>>;
    public createPensioner(
        pensionerEntryDTO?: PensionerEntryDTO,
        observe: any = 'body',
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllNotApprovedPensioners(
        observe?: 'body',
        reportProgress?: boolean,
        options?: {
            httpHeaderAccept?: 'application/json';
    ...
    ): Observable<PensionerListItemDTOIEnumerableDynamicListResultJsonAPIResponse>;
    public getAllNotApprovedPensioners(
        observe?: 'response',
        reportProgress?: boolean,
        options?: {
        ...
        HttpResponse<PensionerListItemDTOIEnumerableDynamicListResultJsonAPIResponse>
    >;
    public getAllNotApprovedPensioners(
        observe?: 'events',
        reportProgress?: boolean,
        ...
        HttpEvent<PensionerListItemDTOIEnumerableDynamicListResultJsonAPIResponse>
    >;
    public getAllNotApprovedPensioners(
        observe: any = 'body',
        reportProgress: boolean = false,
        ...
        return this.httpClient.request<PensionerListItemDTOIEnumerableDynamicListResultJsonAPIResponse>(
            'get',
            `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    public getPensionerByPpoId(
        ...
        if (ppoId === null || ppoId === undefined) {
            throw new Error(
                'Required parameter ppoId was null or undefined when calling getPensionerByPpoId.'
            );
        }
    ...
    public updatePensionerByPpoId(
        ...
        if (ppoId === null || ppoId === undefined) {
            throw new Error(
                'Required parameter ppoId was null or undefined when calling updatePensionerByPpoId.'
            );
        }
