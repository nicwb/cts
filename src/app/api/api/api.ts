...
export const APIS = [MessageQueueWorkerService, PensionService, PensionBankBranchService, PensionCategoryMasterService, PensionComponentService, PensionComponentRateService, PensionComponentRevisionService, PensionFactoryService, PensionFirstBillService, PensionLifeCertificateService, PensionManualPPOReceiptService, PensionNomineeDetailsService, PensionPPODetailsService, PensionPPOStatusService, PensionRegularBillService, PensionSanctionDetailsService];
