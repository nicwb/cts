...
export const APIS = [MessageQueueWorkerService, PensionService, PensionBankBranchService, PensionCategoryMasterService, PensionComponentService, PensionComponentRateService, PensionComponentRevisionService, PensionFactoryService, PensionFirstBillService, PensionManualPPOReceiptService, PensionNomineeDetailsService, PensionPPODetailsService, PensionPPOStatusService, PensionRegularBillService, PensionSanctionDetailsService];
