...
export class PensionRegularBillService extends BaseService {
    constructor(
     ...
     */
    public getAllPposForRegularBill(
        year: number,
        month: number,
        observe?: 'body',
    ...
    ): Observable<PpoListResponseDTOJsonAPIResponse>;
    public getAllPposForRegularBill(
        year: number,
        month: number,
        observe?: 'response',
    ...
    ): Observable<HttpResponse<PpoListResponseDTOJsonAPIResponse>>;
    public getAllPposForRegularBill(
        year: number,
        month: number,
        observe?: 'events',
    ...
    ): Observable<HttpEvent<PpoListResponseDTOJsonAPIResponse>>;
    public getAllPposForRegularBill(
        year: number,
        month: number,
        observe: any = 'body',
        ...
        if (year === null || year === undefined) {
            throw new Error(
                'Required parameter year was null or undefined when calling getAllPposForRegularBill.'
            );
        }
        if (month === null || month === undefined) {
            throw new Error(
                'Required parameter month was null or undefined when calling getAllPposForRegularBill.'
            );
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAllRegularPensionBills(
        year: number,
        month: number,
        categoryId?: number,
        bankId?: number,
    ...
    ): Observable<RegularBillListResponseDTOJsonAPIResponse>;
    public getAllRegularPensionBills(
        year: number,
        month: number,
        categoryId?: number,
    ...
    ): Observable<HttpResponse<RegularBillListResponseDTOJsonAPIResponse>>;
    public getAllRegularPensionBills(
        year: number,
        month: number,
        categoryId?: number,
    ...
    ): Observable<HttpEvent<RegularBillListResponseDTOJsonAPIResponse>>;
    public getAllRegularPensionBills(
        year: number,
        month: number,
        categoryId?: number,
        ...
        if (year === null || year === undefined) {
            throw new Error(
                'Required parameter year was null or undefined when calling getAllRegularPensionBills.'
            );
        }
        if (month === null || month === undefined) {
            throw new Error(
                'Required parameter month was null or undefined when calling getAllRegularPensionBills.'
            );
        }
