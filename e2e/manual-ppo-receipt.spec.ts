...
test.describe('Manual PPO Receipt Component', () => {
    ...
    test.skip('should display the "New Manual PPO Entry" button', async ({ page }) => {
        const newEntryButton = page.locator('button:has-text("New Manual PPO Entry")');
        await expect(newEntryButton).toBeVisible();
    });

    test.skip('should open the modal when "New Manual PPO Entry" button is clicked', async ({ page }) => {
    ...
    test.skip('should display ui after clicking cancel button', async ({ page }) => {
        await page.click('button:has-text("New Manual PPO Entry")');
    ...
    test.skip('should perform search and update table results', async ({ page }) => {
    ...
    test.skip('should load the table with data', async ({ page }) => {
    ...
    test.skip('should change table query to display different number of rows', async ({ page }) => {
    ...
    // Debugging helper
    test.skip('debug: log HTML and take screenshot', async ({ page }) => {
        await page.waitForTimeout(10000);
